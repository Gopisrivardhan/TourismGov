...
const AdminHeritageSites = () => {
    ...
    const handleLogActivity = async (e) => {
        ...
        // Payload matches PreservationActivityRequest
        const payload = {
            description: activityForm.description,
            date: activityForm.date, // Spring Boot expects standard ISO string format (e.g., YYYY-MM-DDTHH:mm)
    ...
    const handleUpdateActivityStatus = async (activityId, newStatus) => {
        try {
            // Updated to match backend PATCH: /tourismgov/v1/preservation/{activityId}/status?status=...
            ...
            <div className="bg-[#1A237E] p-4 px-4 md:px-10 flex justify-between items-center text-white shadow-lg sticky top-0 z-50">
                <div className="flex items-center gap-3 md:gap-4 flex-1">
                    ...
                    <div className="text-base md:text-2xl font-black tracking-tighter flex items-center gap-2 truncate">
                        ...
                        <span className="truncate">TourismGov <span className="hidden sm:inline">| Heritage Sites</span></span>
                    </div>
                </div>
